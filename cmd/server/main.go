...
func setupRoutes(
	...
	// Courier review
	mux.HandleFunc("/api/CourierReview/", corsMiddleware(handleCourierReviewRoute(courierHandler)))
...
func handleCourierReviewRoute(handler *handlers.CourierHandler) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		switch r.Method {
		case http.MethodPost:
			handler.SetReviewToCourier(w, r)
		default:
			writeErrorResponse(w, http.StatusMethodNotAllowed, "Method not allowed")
		}
	}
...
func handleCourierAssignmentRoute(handler *handlers.CourierHandler) http.HandlerFunc {
	return func(w http.ResponseWriter, r *http.Request) {
		switch r.Method {
		case http.MethodPost:
